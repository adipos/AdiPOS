...
namespace Api.Domain.Base
{
     ...
     where TKey : IEquatable<TKey>
    {
        ...
        public DataTransferObject<TDTO> Delete(TDTO dtoObject)
        {
            TEntity entity = ConvertToEntity(dtoObject);
        ...
        {
            var response = Repository.Get(predicate);
        ...
        {   
            var response = new DataTransferObject<TDTO>(ConvertToDto(Repository.GetFirst(tEntity => tEntity.Id.Equals(id))));
            return response;
        }
